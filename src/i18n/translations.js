export const translations = {
  EN: {
    ...
    hero: {
      ...
      subtitle: 'Inspiration of chemistry bring happiness to people',
      contactText: 'If you have any problems or would like a quote, please contact us.',
      button: 'Contact',
    },
    aboutUs: {
      title: 'OG Thailand',
      description: 'OG Trading (Thailand) Co., Ltd. is a specialized trading company providing comprehensive solutions in sales, exports, imports, and inventory-based distribution across Thailand, Malaysia, Indonesia, and Japan. We serve key industries including chemicals, automotive, electronics, resin compounds, and textiles. As part of OG Corporation Japan\'s global network with over 3,300 customers and strong presence in China, India, and Southeast Asia, we deliver tailored solutions that meet your business needs.',
    },
    business: {
      chemical: {
    ...
    contact: {
      ...
      intro: 'OG Trading (Thailand) Co., Ltd. is a specialized trading company providing comprehensive solutions in sales, exports, imports, and inventory-based distribution across Thailand, Malaysia, Indonesia, and Japan. We serve key industries including chemicals, automotive, electronics, resin compounds, textiles and more. As part of OG Corporation, Japan\'s global network with over 3,000 customers and strong presence in China, India and Southeast Asia, we deliver tailored solutions that meet your business needs.',
      company: 'Company',
      companyName: 'OG TRADING (THAILAND) CO., LTD.',
      dateEstablished: 'Date Established',
      dateValue: 'October 30, 2009',
      capital: 'Capital',
      capitalValue: 'THB 12,000,000',
      managingDirector: 'Managing Director',
      directorName: 'Kentaro Yamada (Mr.)',
      shareholders: 'Shareholders',
      shareholderValue: 'Thai shareholders 51% / OG Corporation 49%',
      address: 'Address of office',
      addressValue: '12 Thaniya Bldg., 10th Fl., Unit 1006-1007, Silom Rd., Suriyawongse, Bangrak, Bangkok 10500, Thailand',
      tel: 'TEL: (+66) 0 2 237 8893 (REP)',
      fax: 'FAX: (+66) 0 2 237 8895',
      contactTitle: 'CONTACT',
      contactSubtitle: 'Please feel free to contact us with any questions or to request a quote.',
      yourName: 'Your Name',
      ...
      privacyText: 'Agree',
      privacyLink: '*About our Privacy Policy',
      submit: 'Send',
    },
    footer: {
      company: 'OG TRADING (THAILAND) CO., LTD.',
      address1: '62 Thaniya Bldg., 10th Fl., Unit 1006-1007',
      address2: 'Silom Rd., Suriyawongse, Bangrak, Bangkok 10500, Thailand',
      tel: 'TEL: (+66) 0 2 237 8893 (REP)',
      fax: 'FAX: (+66) 0 2 237 8895',
