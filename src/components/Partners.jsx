...
const Partners = () => {
  ...
  const partners = [
    { name: "DAIM", src: "Logos/Daiwa.svg", alt: "Daiwa Chemical Industries Logo" },
    { name: "TEAMPLAS", src: "Logos/Teamplas Chemical.svg", alt: "Teamplas Chemical Co., Ltd. Logo" },
    { name: "SIAM ECO-KASEI", src: "Logos/Siam Eco.svg", alt: "Siam Eco-Kasei Co., Ltd. Logo" },
  ];
          ...
          {partners.map((partner, index) => (
            <div key={index} className="p-4">
              <img 
                ...
                className="max-h-18 md:max-h-22 w-auto object-contain md:opacity-80 md:hover:opacity-100 transition-opacity"
              />
            </div>
          ))}
        </div>
