  ...
  return (
    <section className="pt-4 pb-8 md:pb-16 px-[5%] max-w-350 mx-auto">
      <div className="bg-[#EBF6FF] border border-[#006CB8] rounded-md p-10 md:p-16 flex flex-col relative">
        ...
        {/* --- PRODUCTS AREA --- */}
        <div className="bg-white mt-10 p-8 md:p-[56px_64px_64px] -mx-10 md:-mx-16 -mb-10 md:-mb-16 rounded-b-md shadow-[0_-8px_12px_rgba(0,0,0,0.06)]">
          <div className="text-center font-noto-sans text-[22px] font-semibold text-[#162b5b] mb-10 relative">
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 w-55 md:w-75 h-0.5 bg-[#162b5b] z-0 "></div>
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 w-25 h-1 bg-white z-0 "></div>
          </div>
...
const BusinessSection = () => {
  ...
  return (
    <div id="business" className='pt-25 md:pt-4'>
