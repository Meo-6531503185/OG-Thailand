...
const Footer = ()=> {
    ...
    return (
        ...
        <div className="container mx-auto px-6 flex flex-col md:flex-row justify-between items-start md:items-center gap-6 text-xs md:text-sm font-noto-sans opacity-90">
          ...
          <div>
              <a 
                href="Privacy Policy Sample_20251114.pdf" // 1. Path relative to public folder
                target="_blank"            // 2. Opens in a new tab
                rel="noopener noreferrer"  // 3. Security best practice for new tabs
                className="hover:text-[#47B6FA] transition-colors border-b border-gray-400 hover:border-[#47B6FA] pb-0.5"
              >
