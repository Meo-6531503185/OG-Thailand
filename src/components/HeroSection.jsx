    ...
    return (
      <section id="home" className="relative w-full h-[60vh] md:h-[90vh] overflow-hidden font-noto-sans">
        ...
        */}
        ...
        {/* Layer 4: Content */}
        <div className="absolute top-0 md:right-4 2xl:right-50 w-full md:w-1/2 h-full flex flex-col justify-center md:items-end items-center text-center md:text-right z-5 px-6 md:px-8 gap-8">
